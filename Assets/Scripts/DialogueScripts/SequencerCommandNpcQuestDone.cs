...
public class SequencerCommandNpcQuestDone : SequencerCommand {
	...
	public void Start() {
		...
		EventFSM.FsmVariables.GetFsmBool("NPCQUEST").Value = true;



		GameObject.Find ("Door2").GetComponent<DoorHandler>().enabled = true;
