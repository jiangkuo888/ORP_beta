...
public class SequencerCommandDidInformLPUM : SequencerCommand {
	...
	public void Start() {
		...
		GameObject.Find ("Dialogue Manager").GetComponent<NPCsync>().startConversation("Quest for missing document","LPU Manager");
