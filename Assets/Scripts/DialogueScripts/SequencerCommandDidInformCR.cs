...
public class SequencerCommandDidInformCR : SequencerCommand {
	...
	public void Start() {
		...
		// on the sequencer.
			...
			//GameObject.Find("Dialogue Manager").GetComponent<DialogueSystemController>().ShowAlert("LPU1 has sent you a new Risk Report.");

		GameObject.Find ("Dialogue Manager").GetComponent<NPCsync>().startConversation("Confirmation of Missing Documents","Credit Risk");
			//GameObject.Find ("EventManager-sahaja").GetComponent<PlayMakerFSM>().FsmVariables.GetFsmBool("CR_DidInformLegal").Value = true;

		if(GameObject.Find ("Missing Documents"))
		{
			disableDocument(GameObject.Find ("Missing Documents"));
...
//		Stop ();
	...
	void disableDocument(GameObject obj){
