...
public class SequencerCommandCRdidGuideLPU : SequencerCommand {
	...
	public void Start() {
		...
		if(PhotonNetwork.playerName == "Credit Risk")
		{
			...
			GameObject.Find ("Credit Risk Table").transform.Find("DocumentHolder").GetComponent<documentData>().removeDocument(GameObject.Find ("Risk Report").gameObject);
			GameObject.Find ("Credit Risk Table").transform.Find("DocumentHolder").GetComponent<documentData>().addDocument(GameObject.Find ("Risk Report Modified").gameObject);
		}
	}
